...
function inicializarTablaCotizacion()
{
                ...
                if ( last !== group ) {
                    ...
                    $(rows).eq(i).before(
                        ...
                        '<tr class="group">'+
                            ...
                            '<i nroBoleta = ' + nroBoleta + ' class="fas fa-print fs-6 text-warning mx-2 btnImprimirCotizacion fw-bold"  style="cursor:pointer;"></i> '+
                            group +  
                            '</td>'+
                        '</tr>'
...
$('#lstCotizacion tbody').on('click','.btnImprimirCotizacion', function(){
    var data = table.row($(this).parents("tr")).data();
    if (table.row(this).child.isShown()) {
        var data = table.row(this).data();
      }
    var idCotizacion = $(this).attr("nroBoleta");

    reImprimirTicketCotizacion(idCotizacion)
...
function reImprimirTicketCotizacion(folio)
{
